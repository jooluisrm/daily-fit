...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.termsAccepted) {
      setLocalError('Você precisa aceitar os termos de serviço e privacidade.');
      return;
    }
    ...
    try {
      await register({
        ...
        // Como o layout não tem mais nome e sobrenome, omitimos aqui.
      });
      // Se sucesso, vamos para o login
      router.push('/login');
    } catch (err: any) {
      setLocalError(err?.response?.data?.error || 'Erro ao registrar. Tente novamente.');
    }
  };
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-2 pt-2">
                <Checkbox 
                  ...
                  className="border-zinc-700 data-[state=checked]:bg-primary data-[state=checked]:border-primary mt-1" 
                />
                <label
                  htmlFor="terms"
