...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-zinc-950">
      ...
      {/* Esquerda: Formulário */}
      <div className="flex flex-col justify-center px-8 py-12 sm:px-16 lg:px-24 xl:px-32 relative">
        ...
        <div className="w-full max-w-sm mx-auto space-y-8 mt-16 lg:mt-0">
          <div className="space-y-2">
            ...
            <p className="text-zinc-400">
              Entre para continuar acompanhando seus treinos
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <label
                    htmlFor="remember"
                    className="text-zinc-400 font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 cursor-pointer"
                  >
                    Lembrar de mim
                  </label>
                </div>
            ...
            <div className="space-y-4 mt-2">
              <Button type="submit" disabled={isPending} className="w-full h-11 text-base font-medium transition-colors">
                {isPending ? 'Entrando...' : 'Entrar'}
              </Button>

              <Button type="button" variant="outline" className="w-full h-11 bg-transparent border-zinc-800 text-zinc-300 hover:bg-zinc-900 hover:text-white transition-colors">
      ...
      {/* Direita: Imagem e Destaque */}
      <div className="hidden lg:flex flex-col items-center justify-center relative p-12 overflow-hidden bg-gradient-to-br from-primary/20 via-secondary/20 to-zinc-950">
        ...
        <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
          ...
          <h2 className="text-2xl font-semibold text-white text-center mb-2">
            A melhor experiência de rastreamento de treinos
          </h2>
          <p className="text-zinc-400 text-center max-w-md">
            Unificando suas rotinas de hipertrofia, cardio e nutrição em um único bloco de notas inteligente.
          </p>
        </div>
      </div>
